...
public class Main {
    ...
    static void checkTheProgramFunctionality() { // для проверки работы программы
        ...
        Epic EpicNumberOne = new Epic(manager.assignID(),"Подготовка к НГ", "" ,
        ...
        Subtask subtaskNumberOne = new Subtask(manager.assignID(),"Генеральная уборка", "Уборка и выброс хлама", TaskStatus.NEW,
        ...
        Subtask subtaskNumberTwo = new Subtask(manager.assignID(), "Купить и упаковать подарки", "",

                TaskStatus.IN_PROGRESS, EpicNumberOne.getId());

        Subtask secondSubtask = manager.createNewSubtask(subtaskNumberTwo);

        Subtask subtaskNumberThree = new Subtask(manager.assignID(), "Купить продукты", "Мясо, рыба, овощи",
        ...
        while (true) {
            ...
            switch (i) {
                ...
                case 14:
                    ...
                    Subtask thirdSubtaskUpdate = manager.updateSubtask(5, subtaskNumber);
